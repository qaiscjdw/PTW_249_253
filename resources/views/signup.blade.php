...
body {
	color: #fff;
	background: linear-gradient(to right, #191919, #19aa8d, #191919);
...
<div class="signup-form">
    <form action="{{route('signup')}}" method="post" class="form-horizontal">
        ...
        <div class="form-group row">
			...
			<div class="col-8">
                <input type="text" class="form-control" name="phone" autocomplete="off" required="required">
            </div>        	
        </div>
		<div class="form-group row">
			<div class="col-8 offset-4">
	...
	<div class="text-center">Already have an account? <a href="/showLogin">Login here</a></div>
</div>
</body>
</html>