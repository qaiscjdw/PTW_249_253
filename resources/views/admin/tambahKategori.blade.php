        ...
        <div id="content">
            ...
            <form action="{{route('tambah_kategori')}}" method="post" enctype='multipart/form-data'>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="namaKategori" class="form-control" placeholder="Kategori" autocomplete="off">
                </div>
            ...
            <?php $i = 1; ?>
                ...
                <tbody>     
                    <td>{{$i}}</td>
                    <td>{{$data -> kategori}}</td>
                    <td><a class="btn btn-danger" href="/admin/hapus_kategori/{{$id}}">X hapus</a></td>
                    <?php $i++; ?>
                @endforeach
            </tbody>
            </table>
