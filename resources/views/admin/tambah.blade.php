...
<body>
    ...
    <div class="wrapper">
        ...
        <div id="content">
            ...
            <form action="{{route('process_upload')}}" method="post" enctype='multipart/form-data'>
                @csrf
                <div class="form-group">
                    <label>Nama barang</label>
                    <input type="text" name="namaBarang" class="form-control" placeholder="Nama" autocomplete="off">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="number" name="hargaBarang" class="form-control" placeholder="Harga">
                </div>
                <div class="form-group">
                    <label>Stok Barang</label>
                    <input type="number" name="stokBarang" class="form-control" placeholder="Stok">
                </div>
