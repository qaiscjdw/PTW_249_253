        ...
        <header class="bg-custom py-5">
            <div class="container px-4 px-lg-5 my-5">
                <div class="text-center text-white">
                    <h1 class="display-4 fw-bolder">012345678910</h1>
                    <p class="lead fw-normal text-white-50 mb-0">Silakan transfer sebesar Rp {{number_format($biaya,0,'','.')}} ke rekening diatas</p>
                </div>
            </div>
        </header>
