    ...
    <body>
        ...
        <table class="table">
            ...
            <tbody>
                ...
                @foreach($data as $db)
                <tr>
                    <?php $total += $db -> harga_barang?>
                    <th>{{$i}}</th>
                    <th>{{$db -> nama_barang}}</th>
                    <th>Rp{{number_format($db -> harga_barang,"0","",".")}}</th>
                    <th><a class="btn btn-danger" href="/user/viewcart/delete/{{$db -> id_user}}/{{$db -> id}}">Delete</a></th>
                    <?php
                        $i++;
                    ?>
                </tr>
                ...
                <tr class="thead-dark">
                    ...
                    <th><a style="width: +73px;" class="btn btn-success" href="/user/viewcart/checkout/{{$idUser}}">Bayar</a></th>
                </tr>
            </tbody>
        </table>
        <!-- Footer-->
